...
# 修改：IC文件路径改为CSV格式的MF IC文件
PRECOMPUTED_IC_PATH = "/misc/hard_disk/others_res/zhangdy/wangluo/node网络特征32维/MF数据/MF_GO_IC_values_actual.csv"
...
def load_precomputed_go_ic():
    """
    修改：加载CSV格式的MF GO IC文件，构建GO ID到IC值的字典
...
def train_model():
    ...
    global SAVE_DIR
    # 修改数据目录为新的MF数据路径
    DATA_DIR = "/misc/hard_disk/others_res/zhangdy/wangluo/node网络特征32维/MF数据/split_data"
    BASE_DIR = "/misc/hard_disk/others_res/zhangdy/wangluo/node网络特征32维/MF数据"
